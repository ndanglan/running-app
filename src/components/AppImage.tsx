 ...
 */
export function AppImage(props: AutoImageProps) {
  const {maxWidth, maxHeight, style, ...fastImageProps} = props;
  ...
  return <FastImage {...fastImageProps} style={[{width, height}, style]} />;
}
