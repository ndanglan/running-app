...
const styles = StyleSheet.create({
  ...
  rightAccessoryStyle: {marginStart: spacing.xs, zIndex: 1},
  leftAccessoryStyle: {marginEnd: spacing.xs, zIndex: 1},
});
...
const $textPresets: Record<Presets, StyleProp<TextStyle>> = {
  default: styles.baseTextStyle,
  filled: styles.baseTextStyle,
  reversed: [styles.baseTextStyle, {color: colors.palette.neutral100}],
};
